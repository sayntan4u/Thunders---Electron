...
class Utility {
    createLegalDocumentAndDeclaration(
        ...
        const outputPathDeclaration = "./legal/DECLARATION - " + prospectName + ".docx" ;//path.resolve(__dirname, "../public/legal/DECLARATION - " + prospectName + ".docx");

        const inputPathLegal = path.resolve(__dirname, "../files/LEGAL.docx");
        const outputPathLegal = "./legal/LEGAL DOCUMENT - " + prospectName + ".docx";//path.resolve(__dirname, "../public/legal/LEGAL DOCUMENT - " + prospectName + ".docx");
